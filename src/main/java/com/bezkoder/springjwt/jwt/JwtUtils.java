package com.bezkoder.springjwt.jwt;
...
//
//        NguoiDungDetail userPrincipal = (NguoiDungDetail) authentication.getPrincipal();
//
//        return Jwts.builder()
...
//                .compact();
//    }
    public String generateJwtToken(NguoiDungDetail userPrincipal) {
